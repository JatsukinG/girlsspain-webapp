...
const TopModelCard: FC<Props> = ({model}) => {
    ...
    return (
        ...
        >
            ...
            <div
                className="absolute top-0 left-0 p-4 bg-purple-600 rounded-br-2xl text-white text-lg font-semibold uppercase tracking-wide flex items-center gap-2">
            ...
            <div
                className="absolute bottom-0 right-0 p-4 bg-purple-600 rounded-tl-2xl text-white text-lg font-semibold uppercase tracking-wide flex items-center gap-2">
                {model.firstName}
            </div>
        </div>
    )
